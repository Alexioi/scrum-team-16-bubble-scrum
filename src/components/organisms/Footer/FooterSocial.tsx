    ...
    <ul className={style.social}>
      <li>
        <Link href="/#" className={style.social__link}>
          <svg className={style.social__icon} fill="url(#twitter)">
      ...
      <li>
        <Link href="/#" className={style.social__link}>
          <svg className={style.social__icon} fill="url(#facebook)">
      ...
      <li>
        <Link href="/#" className={style.social__link}>
          <svg className={style.social__icon} fill="url(#instagram)">
